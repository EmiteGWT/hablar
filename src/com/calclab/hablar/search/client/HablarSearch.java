...
public class HablarSearch implements EntryPoint {
	...
	final SearchPage searchPage = new SearchPage(session, searchManager, visible, config.searchCloseable,
		config.queryFactory, hablar.getEventBus(), new SearchWidget());
