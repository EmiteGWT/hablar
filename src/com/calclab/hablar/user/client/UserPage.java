...
public class UserPage extends PagePresenter<UserDisplay> implements EditorPage<UserDisplay> {
    ...
    public UserPage(HablarEventBus eventBus, final UserDisplay display) {
