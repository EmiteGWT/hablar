...
public class ChatMessageFormatter {
	...
	static {
		...
		patternImagePairs.add(new PatternFactoryReplacement("&gt;:o|&gt;:-o|&gt;:O|&gt;:-O|X\\(|X-\\(|x\\(|x-\\(|:@|&lt;_&lt;", new ImagePatternElementFactory(
				icons.angry()), ANGRY));
		...
		patternImagePairs.add(new PatternFactoryReplacement(":-X|:-xX|:x|\\(wubya\\)|\\(wubyou\\)|\\(wub\\)", new ImagePatternElementFactory(icons.love()),
				LOVE));
		...
		patternImagePairs
				.add(new PatternFactoryReplacement("\\(-.-\\)|\\|\\)|\\|-\\)|I-\\)|I-\\|", new ImagePatternElementFactory(icons.sleeping()), SLEEPING));
