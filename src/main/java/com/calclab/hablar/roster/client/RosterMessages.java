...
public interface RosterMessages extends Messages {
	public static final RosterMessages msg = GWT.create(RosterMessages.class);
	...
	@DefaultMessage("The group ''{0}'' has {1,number} items. Are you sure you want to delete it?")
	String confirmDeleteGroup(String groupName, int itemCount);
	...
	@DefaultMessage("Group: {0} ({1,number})")
	String groupName(String groupName, int groupSize);
