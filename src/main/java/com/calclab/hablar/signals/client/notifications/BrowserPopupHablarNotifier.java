...
public class BrowserPopupHablarNotifier implements HablarNotifier {
	 ...
	 */
	private static String popupHtml = "<!DOCTYPE html\">" + "<html><head>" + "<meta http-equiv=\"content-type\" content=\"text/html; charset=UTF-8\">"
			+ "<style type=\"text/css\">" + "html { font-family: Tahoma, sans-serif; font-size: 80%; } "
			+ "body { background-color: #e9e9e9; margin: 0; padding: 0;	} " + "#notificationContainer { width: 100%; height: 100%; } "
			...
			+ "#notificationContainer p.message a, #notificationContainer p.message a:visited { color: white; text-decoration: none; }" + "</style>"
	...
	public String getDisplayName() {
		return SignalMessages.msg.browserPopupNotifierDisplayName();
	}
