...
public class UnattendedPresenter {
	...
	public UnattendedPresenter(final HablarEventBus hablarEventBus, final SignalPreferences preferences, final UnattendedPagesManager unattendedManager,
	...
	private void showUnattendedInTitle(final int size) {
		final String message = size == 0 ? "" : SignalMessages.msg.unreadChats(size);
