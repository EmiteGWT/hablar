...
public abstract class VCardPage extends PagePresenter<VCardDisplay> {
	...
	protected void displayToModel(final VCard vcard) {
		...
		vcard.getOrganization().setData(VCardOrganization.Data.ORGUNIT, display.getField(Field.organizationUnit).getText());
	...
	protected void modelToDisplay(final VCard vcard) {
		if (vcard != null) {
			...
			display.getField(Field.organizationName).setText(vcard.getOrganization().getData(VCardOrganization.Data.ORGNAME));
			display.getField(Field.organizationUnit).setText(vcard.getOrganization().getData(VCardOrganization.Data.ORGUNIT));
