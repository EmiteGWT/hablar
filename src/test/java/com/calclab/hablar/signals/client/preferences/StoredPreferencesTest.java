...
public class StoredPreferencesTest {
    public static String sample = "<hablarpreferences xmlns=\"hablar:preferences\">"
	    ...
	    + "<roster-notif>true</roster-notif>" + "<notifier-notifieron-enabled>true</notifier-notifieron-enabled>"
	    + "<notifier-notifieroff-enabled>false</notifier-notifieroff-enabled>" + "</hablarpreferences>";
