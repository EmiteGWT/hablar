...
public final class Lorem {
    ...
    public static final String chinese = "吗 台湾 六种辅音韵尾 中国政府要求在中国出售的软件必须使用编码 过国标 名词的复数形式只在代词及多音节 台湾和港澳三地日益加深的经济联系 白话 如上面提到的 个例外可能是 个有意思的问题是中文数据的繁简体转换看 就有明显的区别 推广普通话的效率 虽然不同方言区的人们可能不能互相理解对方的语音 吗 另外, 汉语维基百科 公元前世纪到世纪随着中国大陆政治上的影响不断增加 韩语 上, 文言 新 唐朝和宋朝 历史书书经以及部分的易经 上古汉语存在于周朝前期和中期\n"
	    + "\n"
	    + "过 助词等所构成的句法复杂程度却又大大地超过了以拉丁语为例的曲折性语言 但客家话是在北方移民南下影响中形成的 例如 和 四川 诗经集无论那个年龄层次 相隔只有十公里的当地居民也许已经不能互相理解了, 根据广韵所反映的 在现代汉语的书面语中 由于闽南语的内部分歧比较大 打繁化 汉语与欧洲语言 大陆直至年代 台湾和港澳三地日益加深的经济联系 香港 上, 过 通常 公元年 根据根据切韵涉及到的, 大陆称为普通话助词也用来表达问句问句的语序与陈述句的语序相同 和 日语 华语 未来汉字的发展 汉语还有套复杂的系统用于区分方向有很多文化上的保守人士认为简体中文是不纯的和 过 最后 看 辞海和辞源等汉语言工具书 迫使民间跨越两种书写体系的障碍中国古代的文学家花费了很大的精力来总结汉语的语音体系, 广东东部 揭开中文的历史是个很有趣的问题 在山西绝大部分以及陕西北部 大陆 上\n"
	    + "\n"
	    + "然而 相隔只有十公里的当地居民也许已经不能互相理解了 本地语被认为是更加亲切而用于家庭成员及日常生活中 新, 通常说来 时态等的曲折变化直到上世纪年代中期 了 共有 对多 韵书以对外语的翻译 菲律宾和南亚的些国家使用 过 通常 它可以分为早期虽然不同方言区的人们可能不能互相理解对方的语音 打碎 格 成语 虽然他们可能不能相互理解 事实上也没有因为简繁字体的不通出现交流障碍 上, 头不同于欧洲的很多具有曲折变化的语言 大陆的书法界有的倒是比较流行以繁体汉字来书写 通常\n"
	    + "\n"
	    + "上 为例 极少混淆 通常分为闽北方言 港澳和海外的华人圈中 共有 头 汉语与欧洲语言 有人认为应看上文下理 繁体有些书写形式更有美感澳门和海外华人中间 的简体转化为繁体编码就要困难的多 国标 看, 莆仙方言 及双峰话 昨天 性 云南 湘方言 请参看汉字 上 大陆 体 并举出看不懂 但在文化层面而言, 另外 就有明显的区别 如罗曼语族语言相比 粤方言是汉语中声调最复杂的方言之 体 及 为基础的书面语在安徽南部地区使用 晋语, 汉字 性 是个量词 现代方言的多样性 在汉语中有大量的量词\n";
