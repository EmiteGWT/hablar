 ...
 */
public class InstantMessagingModule extends AbstractModule implements
		EntryPoint {
	...
	public void onInstall() {
		...
		register(SessionComponent.class, new Factory<Roster>(Roster.class) {
			...
			public SubscriptionManager create() {
				return new SubscriptionManagerImpl($(XmppSession.class),
						$(XmppRoster.class));
			}
		}, new Factory<PresenceManager>(PresenceManager.class) {
			@Override
			public PresenceManager create() {
				return new PresenceManagerImpl($(XmppSession.class),
						$(SessionReady.class));
			}
		});
